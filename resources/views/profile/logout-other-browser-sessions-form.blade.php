<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puede cerrar la sesión de todas las demas sesiones en otros navegadores y/o dispositivos. Si cree que su cuenta se ha visto comprometida, tambien debe actualizar su contraseña.') }}
        </div>
