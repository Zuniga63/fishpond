...
<x-admin.form.card {{$attributes}} wire:submit.prevent="submit">
  ...
  <x-slot name="title">
    <span x-show.transition.in="state === 'creating'">Registrar Menú</span>
    <span x-show.transition.in="state === 'editing'">Actualizar Menú</span>
  </x-slot>

  <x-admin.menus.inputs :icon="$icon"/>
