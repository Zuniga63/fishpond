<x-admin.form.card {{$attributes}} wire:submit.prevent="submit">
  ...
  <x-slot name="title">
    <span x-show.transition.in="state === 'creating'">Registrar Permiso</span>
    <span x-show.transition.in="state === 'editing'">Actualizar Permiso</span>
  </x-slot>

  <x-admin.permissions.inputs/>
